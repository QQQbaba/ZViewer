...
// ============ 音频转码（已迁移至浏览器端 ffmpeg.wasm） ============
//
// 原服务端实时音频转码（createAudioTranscodeStream / needsAudioTranscode /
// isFfmpegTranscodeCapable 等）已移除：转码管线迁移到浏览器端执行，
// 服务端流式端点回归纯字节中转。此处仅保留探测与缓存清理。
